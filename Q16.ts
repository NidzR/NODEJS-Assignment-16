...
let guestArr:  string[] = ["Ahsen Rizwan", "Maham Rizwan", "Nmeera Rizwan", "Rumaysa Rizwan"];
let canNotattend: string = "Ahsen Rizwan";
let newGuest: string = "Nida Rizwan";
...
// console.log(guestArr);
let middleGuest:string = "Uzma Imran"
